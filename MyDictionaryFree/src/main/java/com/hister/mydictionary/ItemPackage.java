...
public class ItemPackage {
    ...
    public ItemPackage(int id, String name, String meaningEn, String meaningFa, String examplesEn, String examplesFa, String lastCheckDate, int lastCheckDay, int deck, int index, int countCorrect, int countInCorrect, int count) {
        this.id = id;
        this.name = name;
...
//    }
//
//    public ItemPackage(String name, String meaning, String addDate) {
////        this.id = id;
//        this.name = name;
//        this.meaning = meaning;
//        this.addDate = addDate;
