 ...
 */
class DatabaseHandlerLeitnerIndexesLastDay extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String TABLE_ITEMS = "indexesLastCheckDay";

    // Contacts Table Columns names
    private static final String KEY_ID = "_id";
    private static final String KEY_LAST_DAY = "lastDay";

    public DatabaseHandlerLeitnerIndexesLastDay(Context context) {
...
//        db.execSQL("DROP TABLE IF EXISTS " + TABLE_WORDS);
    ...
    public int updateItem(int id, int newLastDay) {
        SQLiteDatabase db = this.getWritableDatabase();
